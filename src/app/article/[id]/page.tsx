...
export default async function ArticlePage({
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <article className="max-w-none">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 my-7">
          {[
            ...
            <div
              key={stat.label}
              className="bg-forge-900 border border-forge-800 rounded-xl p-4 text-center"
            >
        ...
        <h2 className="text-xl font-bold mt-9 mb-4 text-white">What It Means Going Forward</h2>
      ...
      {/* Rating + Actions */}
      <div className="mt-11 pt-7 border-t border-forge-800">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-4 py-2 bg-forge-800 hover:bg-forge-700 rounded-xl text-sm transition">
              👍 842
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-forge-800 hover:bg-forge-700 rounded-xl text-sm transition">
              💬 48
                ...
                <div className="flex items-center gap-2 text-sm mb-1">
                  <div className="relative group">
                    ...
                    <div className="absolute bottom-full left-0 mb-1.5 hidden group-hover:block z-10">
                      <div className="bg-forge-800 border border-forge-700 text-xs text-white px-2.5 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
                        <div>#{c.rank} Commenter</div>
                        <div className={c.heatColor}>Heat: {c.heat}</div>
                      </div>
                    </div>
                  </div>
