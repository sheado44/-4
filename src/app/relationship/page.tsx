    ...
    <main className="max-w-xl mx-auto px-4 py-10">
      ...
      <div className="bg-green-500/10 border border-green-500/30 rounded-xl px-4 py-3 mb-8">
        ...
        <div className="text-sm text-gray-400 mt-0.5">
          14 likes · 2 dislikes on your content
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-2">
          ...
          <Link
            ...
            className="block bg-forge-900 border border-forge-800 hover:border-forge-700 rounded-xl px-4 py-3 transition"
          >
            <div className="text-xs text-gray-500 mb-1">Your comment on</div>
            <div className="text-sm text-gray-200">
              The Quiet Revolution in NBA Load Management
            </div>
          ...
          >
            <div className="text-xs text-gray-500 mb-1">Your comment on</div>
            <div className="text-sm text-gray-200">
              MLS Attendance Is Surging — But Not Where You Think
            </div>
            <div className="text-xs text-gray-400 mt-1 line-clamp-2">
              “Secondary markets driving growth makes total sense if you’ve been watching the league closely.”
            </div>
          </Link>
      ...
      <div>
        ...
        <div className="space-y-2">
          ...
          >
            <div className="text-xs text-gray-500 mb-1">Your comment on</div>
            <div className="text-sm text-gray-200">
              Why 2026 Touring Is Breaking the Old Festival Model
            </div>
            <div className="text-xs text-gray-400 mt-1 line-clamp-2">
