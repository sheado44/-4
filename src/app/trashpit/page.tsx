...
export default function TrashPitLabPage() {
  ...
  if (!userId) {
    return (
      <main className="max-w-2xl mx-auto px-4 py-10 text-center">
        ...
        <h1 className="text-3xl font-extrabold mb-3"><TrashPitMark /></h1>
        ...
        <p className="text-sm text-muted-pit mb-6">Satire. Fiction. Not reporting. An account is required to generate.</p>
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <h1 className="text-3xl font-extrabold mb-2"><TrashPitMark /></h1>
